...
import { getCategory, getOneProductList, getSubCategory, resetMessage } from './ProductReducer';
        ...
        <div>
            ...
            <Paper elevation={5} sx={{ borderRadius: '10px', padding: '2% 3%', margin: '3% auto', width: '95%' }}>
                <Box sx={{ padding: '10px', width: '100%', borderBottom: 'solid 1px #2424', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Typography variant='p' component='div' sx={{ fontSize: '20px', fontWeight: 'bold', color: '#1976d2' }}>Product Information</Typography>
                ...
                <Box sx={{ height: 'auto', width: '100%', margin: '2% 0', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Box sx={{ width: '100%', height: '100%', padding: '0 10px' }}>
                        <Grid2 container rowSpacing={3} columnSpacing={2}>
                            ...
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>
                                    Category
                                </Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px' }}>
                                    {categoryData?.data?.find(cat => cat.id === additionalData?.category)?.name ?? "-"}
                                </Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Sub Category</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px' }}>
                                    {subCategoryData?.data?.find(cat => cat.id === getOneData?.data?.subCategoryId)?.name ?? "-"}
                                </Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Posted By</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px' }}>
                                    {vendors?.rows?.find(cat => cat.id === getOneData?.data?.postedBy)?.name ?? "-"}
                                </Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Product Name</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{getOneData?.data?.name ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={8}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Product Description</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{getOneData?.data?.description ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Brand Name</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{getOneData?.data?.brandName ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Country</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{additionalData?.country ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Price</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{getOneData?.data?.price ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Shelf Life</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{additionalData?.shelfLife ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Expires On or After</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{getOneData?.data?.expiresOn ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Manufacturer Details</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{additionalData?.manufacturer ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Mediguard Essentials</Typography>
                                <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize' }}>{additionalData?.mediguardDetails ?? "-"}</Typography>
                            </Grid2>
                            <Grid2 item size={4}>
                            ...
                            <Grid2 item size={4}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Product Thumnail</Typography>
                            ...
                            <Grid2 item size={8}>
                                <Typography variant='p' component='div' sx={{ fontSize: '15px', color: '#22442280' }}>Product Image</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexWrap: 'wrap', gap: '12px', marginTop: '5px' }}>
                                    {getOneData?.data?.galleryImage?.length > 0 ? getOneData?.data?.galleryImage?.map((fileUrl, index) => {
