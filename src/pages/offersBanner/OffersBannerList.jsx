...
const OffersBannerList = () => {
  ...
  const handleView = (e) => {
    sessionStorage.setItem("offerId", e?.id);
    sessionStorage.setItem("Mode", "View");
    navigate("/offerBannersView");
  };
  const handleEdit = (e) => {
    sessionStorage.setItem("offerId", e?.id);
    sessionStorage.setItem("Mode", "Edit");
    navigate("/offerBannerEntry");
  };
  ...
  const deleteCustomer = () => {
    setDialogOpen(!dialogOpen);
    dispatch(removeOfferBanner(sessionStorage.getItem("tempRow")));
  };
  ...
  return (
    <div style={{ height: "auto" }}>
      ...
      <Titlebar
        ...
        addBtn={true}
        addClick={() => {
          navigate("/offerBannerEntry"), sessionStorage.setItem("Mode", "Add");
        }}
      />
      <CommonTable
        rows={rows}
        ...
        page={page}
        count={getAllOfferBannerData?.pagination?.totalPages}
