...
import { fetchAllBrand, removeBrand, resetMessage } from "./BrandReducer";
...
const BrandList = () => {
  ...
  const columns = [
    { datakey: "brandImage", headerName: "Img", size: 100 },
    { datakey: "name", headerName: "Name", size: 200 },
    { datakey: "type", headerName: "Type", size: 200 },
    {
      datakey: "status",
      headerName: "Status",
      size: 150,
  ...
  const handleView = (e) => {
    sessionStorage.setItem("brandId", e?.id);
  ...
  const deleteCustomer = () => {
    setDialogOpen(!dialogOpen);
    dispatch(removeBrand(sessionStorage.getItem("tempRow")))
  };
  ...
  return (
    <div style={{ height: "auto" }}>
      ...
      <Titlebar
        ...
        addBtn={true}
        addClick={() => {
          navigate("/brandEntry"), sessionStorage.setItem("Mode", "Add");
        }}
      />
      <CommonTable
        rows={rows}
        ...
        page={page}
        count={getAllBrandData?.pagination?.totalPages}
      ...
      <Modal
        ...
        content={"Are you sure you want to delete this admin user."}
      />
    </div>
  );
};
