                    ...
                    <Box sx={{ width: '100%', height: '100%', padding: '0 10px' }}>
                        <Grid2 container rowSpacing={3} columnSpacing={2}>
                            ...
                            <Grid2 item size={4}>
                                ...
                                {!editFlag ?
                                    <Typography variant='p' component='div' sx={{ fontSize: '18px', textTransform: 'capitalize', color: `${vendorOneData?.data?.status == "approved" ? "green" : vendorOneData?.data?.status == "rejected" ? "red" : "orange"}`, fontWeight: 'bold' }}>{vendorOneData?.data?.status}</Typography>
                                    :
                                    <>
                                        <Select
                                            fullWidth
                            ...
                            <Grid2 item size={8}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexWrap: 'wrap', gap: '12px', marginTop: '5px' }}>
                                    {vendorOneData?.data?.files?.length > 0 ? vendorOneData?.data?.files?.map((fileUrl, index) => {
